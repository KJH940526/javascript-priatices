/*
 ...
 따라서 자바스크립트 객체라고 부르는 것은 object 타입의 객체를 가르킨다. 
 */
...
//  console.log(o2.another);
 ...
 // 생성방법3 JSON(JavaScript Object Notation): 자바스크립트 객체 표기법을 사용하는 방법
 let o3 = {
    "name": '둘리',
    "age": 10,
    "another": {
...
let response = '{"no": 1 , "name": "안대혁", "email":"www.naver.com"}';
